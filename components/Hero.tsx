    ...
    <section className="min-h-screen flex flex-col justify-end px-6 md:px-12 pb-20 pt-32 max-w-7xl mx-auto">
      ...
      >
        ...
        <motion.div variants={item} className="space-y-2">
          <h1 className="font-display font-extrabold text-[clamp(2.5rem,6.5vw,6rem)] leading-[0.9] tracking-tighter text-foreground">
            Huanxuan Li
          </h1>
        ...
        >
          <span className="text-accent font-medium">Huanxuan</span>, also known as <span className="text-accent font-medium">Shawn</span>, is a junior at Thomas Jefferson High School for Science & Technology.
