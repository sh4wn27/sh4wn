  ...
  return (
    ...
    >
      ...
      <div className="h-52 relative overflow-hidden">
        ...
        />
        {/* Number watermark */}
        <div className={`absolute bottom-3 left-5 text-[5rem] font-display font-black leading-none select-none pointer-events-none ${project.number === "04" || project.number === "06" ? "text-white" : "text-black/8"}`}>
          {project.number}
        </div>
        {project.status && (
